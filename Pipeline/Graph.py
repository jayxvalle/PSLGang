...
def plot_data(data: list, method: str = "round",
              ...
              max_points: Optional[int] = 200000) -> dict:
    ...
    # Computed noise region (it's computed right now, just not drawn)
    ...
    scatter = ax.scatter(x_plot, y_plot, c=c_plot, cmap="viridis", s=3, alpha=0.7)
    plt.colorbar(scatter, ax=ax, label="ln(intensity)")
